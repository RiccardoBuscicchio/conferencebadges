...
\DTLforeach{namelist}{%
  ...
  %%%  you've just mapped above.
    \begin{Spacing}{0.75}%
    \noindent
	\textbf{Emerging methods in GW population inference}\\
    IFPU Focus Week Program - 24-27 June 2024\\
    \rule{\textwidth}{.3mm}\\
...
\psbarcode{MECARD:N:\Name;URL:\Web;EMAIL:\Email;TEL:\Mobile;NOTE:\Institution}{eclevel=L width=0.7 height=0.7}{qrcode}
        \end{pspicture}
    \end{minipage}
    \hspace{1mm}
    ...
    \mbox{}\hfill {\scriptsize \includegraphics[height=3.0em]{ifpu.png} \includegraphics[height=3.0em]{logo.jpeg} }
    \end{Spacing}
    \clearpage
}
